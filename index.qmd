...
```{ojs}
etape = seuil.findIndex(num => num > progression);
```
...
x_min_f = d3.scaleLinear()
  ...
  .range((progression<=.5 ? [3234242, 3760524-100000] : [3760524-100000, 3760524-100000]))
  .clamp(true)
  
x_max_f = d3.scaleLinear()
  .domain((progression<=.5 ? [0, .5] : [.5,1]))
  .range((progression<=.5 ? [4322644, 3760524+100000] : [3760524+100000, 3760524+100000]))
  .clamp(true)
  
y_min_f = d3.scaleLinear()
  .domain((progression<=.5 ? [0, .5] : [.5,1]))
  .range((progression<=.5 ? [2016044, 2889128-100000] : [2889128-100000, 2889128-100000]))
  .clamp(true)  

y_max_f = d3.scaleLinear()
  .domain((progression<=.5 ? [0, .5] : [.5,1]))
  .range((progression<=.5 ? [3261111, 2889128+100000] : [2889128+100000, 2889128+100000]))
  .clamp(true)
...
Plot.plot({
  ...
  marks: [
    Plot.geo(carreaux_20000, {fill: (d) => d.properties.ind,
                              fillOpacity: (etape==1 ? 1 : 0)  }),
    Plot.geo(carreaux_5000, {strokeOpacity: 1, fill: (d) => d.properties.ind,
